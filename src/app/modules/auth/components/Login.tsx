  ...
  return (
    ...
    >
      ...
      <div className=' mb-10 d-flex ' style={{ alignItems: 'center' }}>
        ...
        />
        {/* <h2 className='text-dark mb-14 mx-2'>Støtteapparatet AS</h2> */}
      </div>
      {/* begin::Heading */}
      ...
      <div className='fv-row mb-10'>
        <label className='form-label fs-6 fw-bolder text-dark'>Brukernavn</label>
        <input
      ...
      <div className='fv-row mb-10'>
        <div className='d-flex justify-content-between mt-n5'>
          <div className='d-flex flex-stack mb-2'>
            {/* begin::Label */}
            <label className='form-label fw-bolder text-dark fs-6 mb-0'>Passord</label>
            {/* end::Label */}
          </div>
        </div>
        <input
