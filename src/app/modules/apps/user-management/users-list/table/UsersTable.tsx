        ...
        >
          <thead>
            <tr className='text-start text-muted fw-bolder fs-7 text-uppercase gs-0'>
              ...
              <th colSpan={1} role='columnheader' className='min-w-125px  ps-4 rounded-start'>
                NAVN
              </th>
              ...
              <th colSpan={1} role='columnheader' className=' text-end rounded-end px-4'>
                HANDLINGER
              </th>
            </tr>
          </thead>
          <tbody className='text-gray-600 fw-bold'>
            {users?.data.map((user) => (
              <tr role='row' key={user?._id}>
                <td className=''>
                  <div className='d-flex align-items-center'>
                    <div className='symbol symbol-50px me-5'>
                      <Link to={`/user-mangement/user-overview/update-user/${user?._id}`}>
                        <div
                ...
                <td className=''>
                  <div className=''>{moment(user?.last_login).format('DD.MM.YYYY hh:mm')}</div>
                </td>

                <td className=''>{moment(user?.created_at).format('DD.MM.YYYY')}</td>
                <td className='text-end ' style={{ position: 'relative', float: 'right' }}>
                  {/* <div
