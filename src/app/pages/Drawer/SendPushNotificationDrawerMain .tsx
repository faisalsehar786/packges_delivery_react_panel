...
import PushStottespillereSearch from './PushStottespillereSearch'
                      ...
                      >
                        ...
                        <div className=' d-flex  align-items-center mb-7'>
                          <div className='col-lg-7'>
                            <select
                              ...
                              className={clsx(
                                ...
                                {
                                  'is-invalid': formik.touched.noti_type && formik.errors.noti_type,
                                }
                              )}
                            >
                          ...
                          <div className='col-lg-3'>
                            ...
                            >
                              ...
                              />
                              <span className='form-check-label'>Send til alle</span>
                            </label>
                          </div>
                          <div className='col-lg-2'>
                            ...
                            >
                              ...
                              />
                              <span className='form-check-label'>Send til en</span>
                            </label>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          <textarea
                            ...
                            className={clsx('form-control form-control-lg textareapushnoti', {
