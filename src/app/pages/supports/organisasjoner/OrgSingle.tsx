...
import {handleGetRequest, handleGetRequestWithoutRefresh,handleGetRequestWithoutRefreshAndMessage} from '../../../services'
import {ErrorMessageDrawer} from '../../Drawer/ErrorMessageDrawer'
import OrgFormalTable from './OrgFormalTable'
import OrgStottespillereSearch from './OrgStottespillereSearch'
...
export default function OrganisasjonerSingle() {
  ...
  const getLeader = async (org_id: string) => {
    const {data} = await handleGetRequestWithoutRefreshAndMessage(`/organisation/get_leader/${org_id}`)(
      setLoading
    )
    setOrganisation(
      (prev: any) =>
            ...
            <table className='table align-middle gs-0 gy-4 hoverTable'>
              <thead>
                <tr className='fw-bold text-muted bg-light'>
                  ...
                  <th className=' text-end rounded-end px-4'></th>
                </tr>
              </thead>
              <tbody>
