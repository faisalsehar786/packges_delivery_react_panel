...
import { handleGetRequest, handleGetRequestWithoutRefresh } from '../../../services'

const GoalDetailsMain: React.FC = () => {
  const { goalId } = useParams<{ orgId: string; gren: string; goalId: string }>()
              ...
              <div className='row mt-4' style={{ marginBottom: '3rem' }}>
                  ...
                  <div className='d-flex  mb-sm-device'>
                    <div className='symbol symbol-40px me-3'>
                      <div className='d-flex align-items-center bg-white bg-opacity-50'>
                        <i className='fa-duotone  fa-bullseye fs-2' />
                      </div>
                    </div>
                ...
                <div className='col-lg-2'>
                  <div className='d-flex mb-sm-device'>
                    <div className='symbol symbol-40px me-3'>
                      <div className='d-flex align-items-center bg-white bg-opacity-50'>
                        <i className='fa-duotone  fa-wallet fs-2' />
                      </div>
                    </div>
                ...
                <div className='col-lg-2'>
                  <div className='d-flex  mb-sm-device'>
                    <div className='symbol symbol-40px me-3'>
                      <div className='d-flex align-items-center bg-white bg-opacity-50'>
                        <i className='fa-duotone fa-credit-card fs-2' />
                      </div>
                    </div>
                ...
                <div className='col-lg-2'>
                  <div className='d-flex  mb-sm-device'>
                    <div className='symbol symbol-40px me-3'>
                      <div className='d-flex align-items-center bg-white bg-opacity-50'>
                        <i className='fa-duotone fa-circle-exclamation-check fs-2' />
                      </div>
                    </div>
                ...
                <div className='col-lg-2'>
                  <div className='d-flex  mb-sm-device'>
                    <div className='symbol symbol-40px me-3'>
                      <div className='d-flex align-items-center bg-white bg-opacity-50'>
                        <i className='fa-duotone  fa-users fs-2' />
                      </div>
                    </div>
                ...
                <div className='col-lg-2'>
                  <div className='d-flex'>
                    <div className='symbol symbol-40px me-3'>
                      <div className='d-flex align-items-center bg-white bg-opacity-50'>
                        <i className='fa-duotone  fa-calendar-check fs-2' />
                      </div>
                    </div>
