...
export default function StottespillereSingle() {
  ...
  const getSupports = async () => {
    const { data } = await handleGetRequest(`/user/detail_profile/${id}/${sortKey}/${sortOrder}`)(
      setLoading
    )
    setUser(data)
    setBreadcrumbs([
                ...
                <thead>
                  <tr className='fw-bold text-muted bg-light'>
                    ...
                    <th
                      className=''
                      style={{ width: '15%' }}
                      onClick={() => handleSort('sports_category_name')}
                    >
                      Org
                    ...
                    <th
                      className=' '
                      style={{ width: '15%' }}
                      onClick={() => handleSort('support_amount')}
                    >
                      Støttebeløp
                    ...
                    <th style={{ width: '15%' }} onClick={() => handleSort('user_total_amount')}>
                      TOTAL STØTTE
