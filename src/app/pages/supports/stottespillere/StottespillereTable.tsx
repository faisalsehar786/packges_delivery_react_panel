...
const StottespillereTable = () => {
  ...
  const getSupports = async () => {
    const resp = await handleGetRequest('/goal_support/get_all_support_players', {
      params: {page, limit, sortKey: sortKey, sortOrder: sortOrder},
    })(setLoading)
      ...
      <table className='table align-middle gs-0 gy-4'>
        ...
        <thead>
          <tr className='fw-bold text-muted bg-light'>
            ...
            <th className='' style={{width: '15%'}} onClick={() => handleSort('mobile_number')}>
              Kontakt
...
export default StottespillereTable
