...
export default function TenderEditFrom() {
  return (
            ...
            <div className='row mb-6'>
              ...
              <div className='col-lg-8 fv-row fv-plugins-icon-container'>
                <select
                  ...
                  data-select2-id='select2-data-9-zy8v'
                  tabIndex={-1}
                  aria-hidden='true'
                  data-kt-initialized={1}
                >
                  <option value='' data-select2-id='select2-data-11-z0gn'>
                    Select a Country...
                  </option>
                ...
                <span
                  ...
                  dir='ltr'
                  data-select2-id='select2-data-10-daq6'
                  style={{ width: '100%' }}
                >
                  <span className='selection'>
                    <span
                      ...
                      tabIndex={0}
                      aria-disabled='false'
                      aria-labelledby='select2-country-z3-container'
                      aria-controls='select2-country-z3-container'
                    >
                      <span
                        className='select2-selection__rendered'
                        id='select2-country-z3-container'
                        role='textbox'
                        aria-readonly='true'
                        title='Select a country...'
                      >
                        <span className='select2-selection__placeholder'>Select a country...</span>
                      </span>
            ...
            <div className='row mb-6'>
              ...
              <div className='col-lg-8 fv-row fv-plugins-icon-container'>
                ...
                <select
                  ...
                  data-select2-id='select2-data-12-syuu'
                  tabIndex={-1}
                  aria-hidden='true'
                  data-kt-initialized={1}
                >
                  <option value='' data-select2-id='select2-data-14-1mb2'>
                    Select a Language...
                  </option>
                  <option data-kt-flag='flags/indonesia.svg' value='id'>
                ...
                <span
                  className='select2 select2-container select2-container--bootstrap5'
                  dir='ltr'
                  data-select2-id='select2-data-13-f5yg'
                  style={{ width: '100%' }}
                >
                  <span className='selection'>
                    <span
                      ...
                      tabIndex={0}
                      aria-disabled='false'
                      aria-labelledby='select2-language-tr-container'
                      aria-controls='select2-language-tr-container'
                    >
                      <span
                        className='select2-selection__rendered'
                        id='select2-language-tr-container'
                        role='textbox'
                        aria-readonly='true'
                        title='Select a language...'
                      >
                        <span className='select2-selection__placeholder'>Select a language...</span>
                      </span>
                      <span className='select2-selection__arrow' role='presentation'>
                        <b role='presentation' />
                      </span>
            ...
            <div className='row mb-6'>
              ...
              <div className='col-lg-8 fv-row fv-plugins-icon-container'>
                <select
                  ...
                  className='form-select form-select-solid form-select-lg select2-hidden-accessible'
                  data-select2-id='select2-data-15-bmt7'
                  tabIndex={-1}
                  aria-hidden='true'
                  data-kt-initialized={1}
                >
                  <option value='' data-select2-id='select2-data-17-qht4'>
                    Select a Timezone..
                  </option>
                ...
                <span
                  className='select2 select2-container select2-container--bootstrap5'
                  dir='ltr'
                  data-select2-id='select2-data-16-pv14'
                  style={{ width: '100%' }}
                >
                  <span className='selection'>
                    <span
                      ...
                      tabIndex={0}
                      aria-disabled='false'
                      aria-labelledby='select2-timezone-x1-container'
                      aria-controls='select2-timezone-x1-container'
                    >
                      <span
                        className='select2-selection__rendered'
                        id='select2-timezone-x1-container'
                        role='textbox'
                        aria-readonly='true'
            ...
            <div className='row mb-6'>
              ...
              <div className='col-lg-8 fv-row'>
                <select
                  ...
                  className='form-select form-select-solid form-select-lg select2-hidden-accessible'
                  data-select2-id='select2-data-18-ohzd'
                  tabIndex={-1}
                  aria-hidden='true'
                  data-kt-initialized={1}
                >
                  <option value='' data-select2-id='select2-data-20-uhe0'>
                    Select a currency..
                  </option>
                ...
                <span
                  className='select2 select2-container select2-container--bootstrap5'
                  dir='ltr'
                  data-select2-id='select2-data-19-ydki'
                  style={{ width: '100%' }}
                >
                  <span className='selection'>
                    <span
                      ...
                      tabIndex={0}
                      aria-disabled='false'
                      aria-labelledby='select2-currnecy-vx-container'
                      aria-controls='select2-currnecy-vx-container'
                    >
                      <span
                        className='select2-selection__rendered'
                        id='select2-currnecy-vx-container'
                        role='textbox'
                        aria-readonly='true'
                        title='Select a currency..'
                      >
                        <span className='select2-selection__placeholder'>Select a currency..</span>
                      </span>
                      <span className='select2-selection__arrow' role='presentation'>
                        <b role='presentation' />
                      </span>
