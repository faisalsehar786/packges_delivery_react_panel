      ...
      {props.hasparent && (props.Mnename === 'support' || props.Mnename === 'home') && (
        <>
          <AsideMenuItemWithSub to='home/oversikt' hasBullet={false}>
            ...
            <AsideMenuItem
              to='home/rapporter/app'
              title='Rapporter app'
              bsTitle='rapporter app'
              hasBullet={false}
              fontIcon='fa-regular fa-mobile'
              hasparent={true}
              displayMenuCondition='support'
            />
            <AsideMenuItem
              to='home/rapporter/org'
              title='Rapporter org'
              bsTitle='rapporter org'
              hasBullet={false}
              fontIcon='fa-regular fa-sitemap'
              hasparent={true}
              displayMenuCondition='support'
            />
            <AsideMenuItem
              to='home/rapporter/stotte'
              title='Rapporter støtte'
              bsTitle='rapporter stotte'
              hasBullet={false}
              fontIcon='fa-duotone fa-handshake-angle'
              hasparent={true}
              displayMenuCondition='support'
            />
            ...
            <AsideMenuItem
              to='home/organisasjoner'
              title='Organisasjoner'
              bsTitle='Organisasjoner'
            ...
            <AsideMenuItem
              to='home/stottespillere'
              title='Støttespillere'
              bsTitle='Støttespillere'
              fontIcon='fa-duotone fa-people-group'
              hasBullet={false}
              hasparent={true}
              displayMenuCondition='support'
            />
            ...
            <AsideMenuItem
              ...
              bsTitle='Endre bruker organisasjon'
