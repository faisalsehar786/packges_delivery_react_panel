  ...
  return (
    ...
    >
      <div className=' mb-10'>
        ...
        {/* begin::Link */}
        <div className='text-gray-400'>Skriv inn ditt brukernavn for å resette passord</div>
        {/* end::Link */}
      </div>
      ...
      <div className='fv-row mb-10'>
        <label className='form-label fw-bolder text-gray-900 fs-6'>Brukernavn</label>
        <input
          type='email'
