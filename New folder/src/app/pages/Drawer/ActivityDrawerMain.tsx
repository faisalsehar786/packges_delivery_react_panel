...
const ActivityDrawerMain: FC = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      const { data } = await handlePostRequest('/zendesk/admin_create_ticket', body, {})(setLoading)
      if (data) resetForm()
    },
  })
  ...
  //       'https://api.stotte.no/api/v1/zendesk/admin_create_ticket',
  //       data
  //     )
  //     setSuccessMessage(
      ...
      <div className='card shadow-none rounded-0 border-none'>
        <div className='card-header' id='kt_activities_header'>
          <div className=' d-flex align-items-center'>
            ...
            <div className='ms-4'>
              <h3 className='fs-5 fw-bolder text-gray-900 mb-0'>Kontakt Support</h3>
              <span className='fw-bold fs-7 text-gray-400'>eller meld inn feil</span>
            </div>
          </div>
