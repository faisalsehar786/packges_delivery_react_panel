...
const ProfileDetails: React.FC = () => {
  ...
  const formik = useFormik<any>({
    ...
    onSubmit: async (values) => {
      ...
      const { data } = await handlePostRequest(`/admin/signup`, formData, {})(setLoading)
        ...
        <form onSubmit={formik.handleSubmit} noValidate className='form'>
          <div className='card-body border-top p-9'>
            <div className='row mb-6'>
              <label className='col-lg-4 col-form-label fw-bold fs-6'>Profilbilde</label>
            ...
            <div className='row mb-6'>
              <label className='col-lg-4 col-form-label fw-bold fs-6'> Navn: </label>
