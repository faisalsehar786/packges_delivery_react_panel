...
class DrawerComponent {
  ...
  private _deleteOverlay = () => {
    if (this.overlayElement !== null && this.overlayElement.parentNode) {
      // console.log(this.overlayElement.parentNode.classList.contains(''))
      const mydivclass: any = document.querySelector('body')
      // if 'hasClass' is exist on 'mydivclass'
      if (mydivclass.classList.contains('mobileVer')) {
        $('.menue-drawrCustom').attr('style', 'display: none !important')
      }
